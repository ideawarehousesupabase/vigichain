...
import { O as Outlet, f as useRouterState, u as useNavigate, L as Link } from "./_libs/tanstack__react-router.mjs";
...
import { b as useAuth, l as logOut } from "./_ssr/router-lDJB15sn.mjs";
...
import { u as ShieldHalf, o as LogOut, S as Search, B as Bell, d as ChevronDown, P as PanelLeft, X, L as LayoutDashboard, h as Cpu, x as TriangleAlert, a as BellRing, l as FileText, C as ChartColumn, t as ShieldCheck, b as Building2, U as User } from "./_libs/lucide-react.mjs";
...
function AppSidebar() {
  ...
  const isActive = (u) => path === u || path.startsWith(u + "/");
  const renderGroup = (label, items) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SidebarGroup, { children: [
    !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupLabel, { children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuButton, { asChild: true, isActive: isActive(item.url), tooltip: item.title, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: item.url, className: "flex items-center gap-3", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarHeader, { className: "border-b border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-2 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldHalf, { className: "h-5 w-5" }) }),
      !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-sidebar-foreground", children: "VigiChain" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-sidebar-foreground/60", children: "MedSecure · PMS" })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarFooter, { className: "border-t border-sidebar-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenu, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      SidebarMenuButton,
      {
        tooltip: "Log out",
        onClick: async () => {
        ...
        children: [
          ...
          !collapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Log out" })
        ]
      }
    ) }) }) })
  ] });
...
function TopBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 flex h-16 items-center gap-3 border-b bg-background/80 px-4 backdrop-blur md:px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative hidden flex-1 max-w-md md:block", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { placeholder: "Search devices, incidents, reports…", className: "pl-9 bg-muted/40 border-transparent focus-visible:bg-background" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "hidden gap-1.5 border-success/30 bg-success/10 text-success md:inline-flex", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-success animate-pulse" }),
        " MHRA SI 2024/1368"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/notifications", className: "relative rounded-md p-2 hover:bg-muted", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-lg border bg-card px-2 py-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden text-left leading-tight sm:block", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium", children: user?.name || "User" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: user?.organization || "—" })
        ] }),
...
function AppLayout() {
  ...
  if (!user) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center text-muted-foreground", children: "Redirecting…" });
